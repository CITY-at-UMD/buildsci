...
<html>
	...
	<body>
		...
		Floors: <input type="text" name="floors" value=""/><br/>
		Area (total floor) [m<sup>2</sup>]: <input type="text" name="floorArea" value="" /><br/>
		</fieldset>
		<br/>
		...
		% Windows: <input type="text" name="windowPercent" value=""/><br/>
		</fieldset>
		<br/>
