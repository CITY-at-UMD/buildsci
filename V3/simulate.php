...
//########################################################################	
	...
	echo "<a href='/V3/result/' target='_blank'>Simulation Results</a> | ";

        #echo "<a href='/V3/Buildings/Output/". $IDFfile ."Table.html' target='_blank'>Results Table</a>";


#	echo "<br>#####################################################<br>";
        $resultTablePath = "/V3/Buildings/ENERGYPLUS/".$IDFfile.".idf/EnergyPlus/eplustbl.htm";
 #       echo "result table path: $resultTablePath";
