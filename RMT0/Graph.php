...
class Graph{
		...
		$bar=' 		<script type="text/javascript">
					...
					<div id="bar_chartdiv" style="width: 100%; height: 100%"></div>';
		return $bar;
	}
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $pie='       
        ...
        <div id="'.$title.'pie_chartdiv" style="width: 100%; height: 90%"></div>';
		return $pie;
	}
    ...
    public function pieMonthlyChart($dataSet) {
      $pieMonthly='       
            ...
            <div id="pieMonthlyChartdiv" style="width: 100%; height: 90%"></div>';
            return  $pieMonthly;
    }
