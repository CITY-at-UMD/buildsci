...
<html>
	...
	<body>
		...
		<fieldset>
		<legend>USER</legend>
		Email: <input type="text" name="eMail" value="jsa161@psu.edu" /><br/>
		Building (name): <input type="text" name="buildingName" value="JinAnTestBuilding" /><br/>
		</fieldset>
		<br/>
		...
		Area (total floor) [m<sup>2</sup>]: <input type="text" name="floorArea" value="100" /><br/>
		</fieldset>
		<br/>
		...
		% Windows: <input type="text" name="windowPercent" value="100"/><br/>
		</fieldset>
		<br/>
