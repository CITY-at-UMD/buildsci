...
#save the OpenStudio model (.osm)
#model.save_openstudio_osm({"osm_save_directory" => "/home/virtualpulse/output",
#                           "osm_name" => "exampleVirtualPULSEModel.osm"})
...
#translate the OpenStudio model (.osm) to an EnergyPlus model (.idf)
model.translate_to_energyplus_and_save_idf({"idf_save_directory" => Dir.pwd+"/Buildings",
                                            "idf_name" => "exampleVirtualPULSEModel.idf"})
...
#run the EnergyPlus model (.idf)
#VirtualPULSEModel::run_energyplus_simulation({"idf_directory" => Dir.pwd+"/Building",
#                                              "idf_name" => "exampleVirtualPULSEModel.idf"})
