...
AmCharts.AmChart = AmCharts.Class({
    ...
    drb: function() {
        ...
        if (e != b) {
            ...
            e = AmCharts.rect(this.container, '', 20, "#eee", 1);
            f = AmCharts.text(this.container, "", "#000000", "Verdana", 11, "start");
            f.translate(7, 9);
            ...
            if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs && Infinity != this.min && -Infinity != this.max) {
                ...
                for (e = p; e < q; e += r) if (p = this.step * e + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !(this.integersOnly && Math.round(p) != p)) {
                    ...
                    if (p == this.baseValue && "radar" != j) {
                        ...
                        K && (d = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), d = AmCharts.line(a.container, K, F, this.gridColor, d, 1, this.dashLength), d.translate(p, v), this.grid0 = d, a.axesSet.push(d),
                        d.toBack())
                    }
                }
                e = this.baseValue;
...
AmCharts.RadItem = AmCharts.Class({
    construct: function(a, b, d, e, f, g, h) {
        ...
        void 0 != h.lineColor && (s = h.lineColor), isNaN(h.lineAlpha) || (q = h.lineAlpha), isNaN(h.dashLength) || (t = h.dashLength), isNaN(h.lineThickness) || (n = h.lineThickness), !0 == h.inside && (x = !0)) : d || (q /= 3, p /= 2);
        var F = "end",
            Y = -1;
        x && (F = "start", Y = 1);
        if (y) {
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function() {
        ...
        for (L = K; L <= F; L++) {
            ...
            if (qa) {
                ...
                switch (g) {
                case "line":
                    isNaN(S) ? p || (this.drawLineGraph(q, n, ga, ha), q = [], n = [], ga = [], ha = []) : (z.isNegative = S < G ? !0 : !1, q.push(B),
                    n.push(A), X = B, $ = A, oa = B, pa = A, Ga && (!isNaN(M) && !isNaN(R)) && (ga.push(R), ha.push(M)));
                    break;
                case "smoothedLine":
                ...
                case "candlestick":
                    if (!isNaN(ia) && !isNaN(Za) && !isNaN(Ya) && !isNaN(S)) {
                        ...
                        if (l) {
                            ...
                            var ja = new AmCharts.Cuboid(e, H, aa, y, x, ua,
                            Ha, O, ma, T, U, r, l),
                                cb, db;
    ...
    drawSmoothedGraph: function(a, b, d, e) {
        if (1 < a.length) {
            ...
            if (0 < l && (k = a.join(";").split(";"), s = b.join(";").split(";"), j = "", 0 < d.length ? (d.reverse(), e.reverse(), k = a.concat(d), s = b.concat(e)) : (this.rotate ? (j += " L" + n + "," + b[b.length - 1], j += " L" + n + "," + b[0]) : (j += " L" + a[a.length - 1] + "," + n, j += " L" + a[0] + "," + n), j += " L" + a[0] + "," + b[0]), d = new AmCharts.Bezier(g, k, s, NaN, 0, 0, m, l, f, j), h.push(d.path),
            p || void 0 != r)) q || (q = l), p || (p = r), a = new AmCharts.Bezier(g, a, b, NaN, 0, 0, p, q, f, j), i.push(a.path);
            this.applyMask(i, h)
        }
    },
