...
function valForm(theForm)
{
	...
	if(floorArea =="" ||floorArea < 50 || floorArea > 99999){
		err_msg+="Area \n";
	}
	if(roofMaterial ==""){
...
<header>
	<div style="margin-left: 50px; font-size: 18px;" >
		<h1> <a href="index.php" style="text-shadow: 0 2px 10px #888"> RMT 3 </a> </h1>
...
<form id="baseline-form" method="post" action="" onsubmit="return valForm('baseline-form');">
	...
	<legend>FUNCTION &amp SIZE</legend>
		...
		Area (total floor) [m<sup>2</sup>]: <input type="number" name="floorArea"  min="50" max="99999" placeholder=" 50 - 99999" value="<?php echo $_POST[floorArea];?>" /><br/>
	</fieldset>
	<br/>
