class VirtualPULSEModel < OpenStudio::Model::Model
  ...
  def add_design_days()
    ...
    ddy_path = OpenStudio::Path.new("#{weather_path.to_s}/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.idf") 
	#ddy_path_1 =    OpenStudio::Path.new("#{weather_path.to_s}/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.ddy") 
...
##############################################################################################
  def add_monthly_data(params)
  file_path = params["file_path"];
  
	idf_file = File.new(file_path, "a")
