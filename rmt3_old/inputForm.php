...
<body>
	...
	Floors: <input type="number" min="1" max="300" name="floors" value=""/><br/>
	Area (total floor) [m<sup>2</sup>]: <input type="number" name="floorArea"  min="1" max="100000" value="" /><br/>
	</fieldset>
	<br/>
	...
	% Windows: <input type="number" min="10" max="60" name="windowPercent" value=""/><br/>
	</fieldset>
	<br/>
