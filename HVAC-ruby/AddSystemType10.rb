...
# == Synopsis 
#
#   Adds System Type 10 - Electric Furnace to each zone in a model
#   
# == Usage
#
...
class AddSystemType10 < OpenStudio::Ruleset::ModelUserScript

  # override name to return the name of your script
  def name
    return "Add A System Type 10 - Electric Furnace to Each Zone"
  end
...
AddSystemType10.new.registerWithSketchUp
