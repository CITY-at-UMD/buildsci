...
# == Synopsis 
#
#   Adds System Type 8 - VAV with PFP Boxes to a model
...
class AddSystemType8 < OpenStudio::Ruleset::ModelUserScript

  # override name to return the name of your script
  def name
    return "Add A System Type 8 - VAV with PFP Boxes"
  end
...
AddSystemType8.new.registerWithSketchUp
