...
# == Synopsis 
#
#   Adds System Type 5 - Packaged VAV with Reheat to each zone in a model
...
class AddSystemType5 < OpenStudio::Ruleset::ModelUserScript

  # override name to return the name of your script
  def name
    return "Add A System Type 5 - Packaged VAV with Reheat to Model"
  end
...
AddSystemType5.new.registerWithSketchUp
