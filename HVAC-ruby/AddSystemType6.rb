...
# == Synopsis 
#
#   Adds System Type 6 - Packaged VAV with PFP Boxes to a model
...
class AddSystemType6 < OpenStudio::Ruleset::ModelUserScript

  # override name to return the name of your script
  def name
    return "Add A System Type 6 - Packaged VAV with PFP Boxes to Model"
  end
...
AddSystemType6.new.registerWithSketchUp
